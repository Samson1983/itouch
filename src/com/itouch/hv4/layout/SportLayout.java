...
//							Log.e("System.out","拖动-----------" + ball.getBallid());
     ...
     //获取电话服务
     manager = (TelephonyManager) cnt.getSystemService(Context.TELEPHONY_SERVICE);
...
//				System.out.println("--finish---ft:"+ft);
				if (!clearFlag){
//					System.out.println("---------finish clearFlag vielw----------");
					AppVersionAdapter.stopMainActivity(null);//关闭         
					clearFlag = true;
				}
			}
		}
...
// 
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
    	  ...
    	  Log.e(Constant.TAG, "onKeyDown:"+keyCode+"");
            switch(keyCode) {            
            case KeyEvent.KEYCODE_BACK:
            	Log.e(Constant.TAG, "返回键,丫的，看你往哪里跑!");
            	if (!firstLongClick){
            		firstLongClick = true;
            ...
            case KeyEvent.KEYCODE_MENU:
            	Log.e(Constant.TAG, "菜单键，看你往哪里跑!");

//            	ZhuoyuUIUtil.reStartApp(cnt); //重启app
