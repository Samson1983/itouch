...
implements SurfaceHolder.Callback{
		...
		public List<Ball_v2> getBallList() {
			return ballList;
		}


		public void setBallList(List<Ball_v2> ballList) {
		...
		public BallSurfaceView(Context context) {
                   ...
                   ball = new Ball_v2(1,0,320,this); 
                   ball2 = new Ball_v2(2,180,0,this);
                   ballList = new ArrayList<Ball_v2>();
                   ballList.add(ball);
                   ballList.add(ball2);
...
//											this.imgIndex = 0;
											AppVersionAdapter.stopMainActivity(this.sportActivity);//关闭    											
...
//        			 +Constant.fillScreen);
        		...
        		if(!Constant.fillScreen){ //非全屏去掉状态栏的高度
