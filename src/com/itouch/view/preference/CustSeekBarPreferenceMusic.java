...
import com.itouch.view.TabHostSample;
 ...
 *
 */
public class CustSeekBarPreferenceMusic extends Preference implements 
OnSeekBarChangeListener {
	...
	public CustSeekBarPreferenceMusic(Context context) {

		super(context);
	}

	public CustSeekBarPreferenceMusic(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected View onCreateView(ViewGroup parent) {
		...
		ZhuoyuUIUtil.setSummarySize(summary);
...
//		System.out.println("0000----8-------"+this.oldValue);
		Constant.musicValue = (float) (this.oldValue * 0.1);
