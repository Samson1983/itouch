...
public class CustToggleButtonPreference extends Preference  {
	private Boolean oldValue = false; // 默认情况是false

	public CustToggleButtonPreference(Context context) {
		super(context);
	}

	public CustToggleButtonPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//		summary.setBackgroundColor(Color.BLUE);
		...
		final ToggleButton tbtn = new ToggleButton(getContext()); // 定义		
		// ToggleButton
		// 用于设置ON/OFF
