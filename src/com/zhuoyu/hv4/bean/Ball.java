...
//	private MainActivity sa;
	...
	public void setBallSize(int ballSize) {
		this.ballSize = ballSize;
         ...
         public Ball(int ballId,int x, int y){
                   paint = new Paint();
...
//        	       sa = bsv.getSportActivity();
        	       ...
        	       System.out.println("------------MainActivity.ballSpeed:"+MainActivity.ballSpeed);
        	    	 x_increase = - MainActivity.ballSpeed; 
        	    	 y_increase = - MainActivity.ballSpeed /2;
//                   x_increase = -8;
//                   y_increase = -4;
                   System.out.println("x:"+x_increase+"y:"+y_increase);
         }
         
         public void onDrawList(List<Ball> ballList){
...
//						Log.e("System.out", "碰.........需要转向");
					...
					if (x_increase == 0 && y_increase == 0){
		        	       	 x_increase = - MainActivity.ballSpeed -1; 
		        	    	 y_increase = - MainActivity.ballSpeed /2 -1;					
