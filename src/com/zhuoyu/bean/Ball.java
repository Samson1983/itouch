...
import com.zhuoyu.view.BallSurfaceView;
...
public class Ball {
	...
	public void setBallSize(int ballSize) {
		this.ballSize = ballSize;
         ...
         public Ball(int ballId,int x, int y, BallSurfaceView bsv){
                   paint = new Paint();
...
//                   y_increase = -4;
         ...
         public void onDrawList(Canvas canvas,List<Ball> ballList){
...
//						Log.e("System.out", "碰.........需要转向");
					...
					if (x_increase == 0 && y_increase == 0){
		        	       	 x_increase = - sa.getBallSpeed() -1; 
		        	    	 y_increase = - sa.getBallSpeed() /2 -1;					
